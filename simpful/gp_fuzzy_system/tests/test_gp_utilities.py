...
class TestLogicalOperatorMutation(unittest.TestCase):
    ...
    def test_not_insertion(self):
        ...
        # Manually specify the operator and index where NOT should be inserted
        mutate_target = {'operator': 'OR', 'index': sentence.find('unemployment_rate IS High') - 4}  # Adjust index appropriately
